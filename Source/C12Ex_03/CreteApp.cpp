...
void CrateApp::LoadTextures()
{
	...
	mTexture[woodCrateTex->Name] = std::move(woodCrateTex);
}
...
void CrateApp::BuildDescriptorHeaps()
{
	...
	auto woodCrateTex = mTexture["woodCrateTex"]->Resource;
...
void CrateApp::BuildShadersAndInputLayout()
{
	...
	mShaders["opaqueGS"] = d3dUtil::CompileShader(L"Default.hlsl", nullptr, "GS", "gs_5_0");
...
void CrateApp::BuildShapeGeometry()
{
	...
	GeometryGenerator::MeshData box = geoGen.CreateGeosphere(2, 1);
...
void CrateApp::BuildPSOs()
{
	...
	opaquePsoDesc.GS =
	{
		reinterpret_cast<BYTE*>(mShaders["opaqueGS"]->GetBufferPointer()),
		mShaders["opaqueGS"]->GetBufferSize()
	};
