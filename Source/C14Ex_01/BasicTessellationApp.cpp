...
class BasicTesellationApp : public D3DApp
{
public:
	BasicTesellationApp(HINSTANCE hInstance);
	BasicTesellationApp(const BasicTesellationApp& rhs) = delete;
	BasicTesellationApp& operator=(const BasicTesellationApp& rhs) = delete;
	~BasicTesellationApp();
	...
	PSTR cmdList, int showCmd)
{
	...
	try
	{
		BasicTesellationApp theApp(hInstance);
...
BasicTesellationApp::BasicTesellationApp(HINSTANCE hInstance) : D3DApp(hInstance)
{
}
BasicTesellationApp::~BasicTesellationApp()
{
	if (md3dDevice != nullptr)
		FlushCommandQueue();
}

bool BasicTesellationApp::Initialize()
{
...
void BasicTesellationApp::OnResize()
{
	D3DApp::OnResize();
...
void BasicTesellationApp::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void BasicTesellationApp::Draw(const GameTimer& gt)
{
...
void BasicTesellationApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void BasicTesellationApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}
void BasicTesellationApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void BasicTesellationApp::OnKeyboardInput(const GameTimer& gt)
{
}
void BasicTesellationApp::UpdateCamera(const GameTimer& gt)
{
...
void BasicTesellationApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void BasicTesellationApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void BasicTesellationApp::BuildRootSignature()
{
...
void BasicTesellationApp::BuildDescriptorHeaps()
{
...
void BasicTesellationApp::BuildShadersAndInputLayout()
{
...
void BasicTesellationApp::BuildQuadPatchGeometry()
{
	constexpr int vCount = 3;

	std::array<XMFLOAT3, vCount> vertices =
	{
	...
	std::array<std::uint16_t, vCount> indices;
...
void BasicTesellationApp::BuildConstantBufferViews()
{
...
void BasicTesellationApp::BuildPSOs()
{
...
void BasicTesellationApp::BuildFrameResources()
{
...
void BasicTesellationApp::BuildRenderItems()
{
...
void BasicTesellationApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
	UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(ObjectConstants));
