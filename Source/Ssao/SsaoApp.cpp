...
void SsaoApp::BuildSsaoRootSignature()
{
	...
	CD3DX12_STATIC_SAMPLER_DESC depthMapSam(
		2,
		D3D12_FILTER_MIN_MAG_MIP_LINEAR,
	...
	std::array<const CD3DX12_STATIC_SAMPLER_DESC, 4> staticSamplers =
	{
...
void SsaoApp::BuildPSOs()
{
	...
	ssaoPsoDesc.RTVFormats[0] = Ssao::NormalMapFormat;
