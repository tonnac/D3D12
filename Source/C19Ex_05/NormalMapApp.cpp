...
private:
	...
	static const UINT mTextureNum = 10;
...
void NormalMapApp::BuildRootSignature()
{
	...
	texTable1.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 3, 1, 0);

	CD3DX12_DESCRIPTOR_RANGE texTable2;
	texTable2.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 6, 0, 2);
...
void NormalMapApp::BuildDescriptorHeaps()
{
	...
	std::vector<ComPtr<ID3D12Resource>> tex2DList =
	{
		...
		mTextures["waveNormalMap1"]->Resource,
...
void NormalMapApp::BuildShapeGeometry()
{
	...
	auto totalVertexCount = box.Vertices.size() + sphere.Vertices.size() + cylinder.Vertices.size();
...
void NormalMapApp::BuildRenderItems()
{
	...
	for (int i = 0; i < 5; ++i)
	{
		...
		XMMATRIX leftCylWorld = XMMatrixTranslation(-5.0f, 1.0f, -10.0f + i * 5.0f);
		XMMATRIX rightCylWorld = XMMatrixTranslation(+5.0f, 1.0f, -10.0f + i * 5.0f);

		XMMATRIX leftSphereWorld = XMMatrixTranslation(-5.0f, 3.0f, -10.0f + i * 5.0f);
		XMMATRIX rightSphereWorld = XMMatrixTranslation(+5.0f, 3.0f, -10.0f + i * 5.0f);
