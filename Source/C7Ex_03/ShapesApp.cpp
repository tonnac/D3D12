...
void ShapesApp::BuildShapeGetmetry()
{
...
void ShapesApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&skullRitem->World, XMMatrixScaling(2.5f, 2.5f, 2.5f) * XMMatrixTranslation(0.0f, 1.5f, 0.0f));
