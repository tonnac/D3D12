...
void BlurApp::BuildDescriptorHeap()
{
...
void BlurApp::BuildShadersAndInputLayout()
{
	...
	mShaders["horzBlurCS"] = d3dUtil::CompileShader(L"blur.hlsl", nullptr, "HorzBlurCS", "cs_5_0");
	mShaders["vertBlurCS"] = d3dUtil::CompileShader(L"blur.hlsl", nullptr, "vertBlurCS", "cs_5_0");
